...
exports.applyEmpathy = (outputFolder, includes, excludes) => __awaiter(this, void 0, void 0, function* () {
    ...
    try {
        ...
        log.error('Unable to stage assets for specifier conversion');
        log.error(error);
        return;
    }
    try {
        ...
        log.info('Empathy applied!');
    }
    catch (error) {
        log.error('Failed to transform asset specifiers');
        log.error(error);
    }
    try {
...
exports.reverseEmpathy = (globs, assetsFolder, outputFolder) => __awaiter(this, void 0, void 0, function* () {
    try {
        ...
        log.error('Failed to transform source specifiers');
        log.error(error);
    }
});
